...
function updateClock() {
    ...
    setDataToID('current_time_en', timeString);
    setDataToID('current_time_nep', localizeNumber(timeString));
    ...
    if (!isSameDay(previousDate, currentDate)) {
        ...
        setDataToID('current_date_en', dateString[0]);
        setDataToID('current_date_nep', localizeNumber(dateString[1]));
