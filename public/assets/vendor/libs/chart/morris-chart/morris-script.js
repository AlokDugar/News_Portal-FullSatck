...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            ykeys: ['y', 'z'],
            labels: ['Y', 'Z'],
            lineColors: [JobAdminConfig.secondary , JobAdminConfig.primary ],
        }), Morris.Line({
            ...
            xkey: "y",
            ykeys: ["a", "b"],
            lineColors: [JobAdminConfig.primary , JobAdminConfig.secondary ],
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: [JobAdminConfig.primary , JobAdminConfig.secondary ,"#51bb25"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            ykeys: ["y"],
            labels: ["Y"],
            barColors: [JobAdminConfig.primary]
        }), $(function() {
            var b = [{
                period: "2022-10-01",
                licensed: 5000,
            ...
            Morris.Bar({
                ...
                data: b,
                barColors: [JobAdminConfig.primary , JobAdminConfig.secondary ],
                xkey: "period",
            ...
            window.m = Morris.Line({
                ...
                labels: ["sin(x)"],
                parseTime: !1,
                lineColors: [JobAdminConfig.primary],
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: [JobAdminConfig.primary , JobAdminConfig.secondary ,"#f8d62b" ,"#51bb25" ,"rgba(248, 214, 43, 1)", "#51bb25" ,"#f8d62b"],
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: [JobAdminConfig.primary , JobAdminConfig.secondary ,"#51bb25" ,"#f8d62b" ,"#a927f9", JobAdminConfig.secondary , JobAdminConfig.primary ],
                stacked: !0
            });
        });
    }
