...
var barData = {
    ...
    datasets: [{
        ...
        highlightStroke: JobAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(255, 206, 0, 0.4)",
        strokeColor: JobAdminConfig.secondary ,
        highlightFill: "rgba(255, 206, 0, 0.6)",
        highlightStroke: JobAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight:JobAdminConfig.primary,
        label: "Yellow"
    }, {
        value:50,
        color:"#f8d62b",
        ...
        highlight: JobAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: JobAdminConfig.primary ,
        pointColor: JobAdminConfig.primary ,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#fff",
        pointHighlightStroke: JobAdminConfig.primary,
        data: [10, 59, 80, 81, 56, 55, 40]
    }, {
        label:"My Second dataset",
        fillColor:"rgba(255, 206, 0, 0.3)",
        strokeColor:JobAdminConfig.secondary ,
        pointColor:JobAdminConfig.secondary ,
        pointStrokeColor:"#fff",
        pointHighlightFill:JobAdminConfig.primary,
        pointHighlightStroke: JobAdminConfig.secondary,
        data:[28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: JobAdminConfig.primary,
        pointColor: JobAdminConfig.primary,
        pointStrokeColor: JobAdminConfig.primary,
        pointHighlightFill: JobAdminConfig.primary ,
