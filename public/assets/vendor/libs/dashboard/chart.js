...
var optionslinechart2 = {
  ...
  colors: [JobAdminConfig.secondary],
  series: [
    {
      name: "series1",
...
var optionscolumnchart = {
  ...
  fill: {
    colors: [JobAdminConfig.primary, JobAdminConfig.secondary, "#51bb25"],
    type: "gradient",
    gradient: {
      shade: "light",
      type: "vertical",
...
var optionsuserchart = {
  ...
  colors: [
    JobAdminConfig.primary,
    JobAdminConfig.secondary,
    "#51bb25",
    "#4faad5",
  ],
  title: {
...
var optionsProgress1 = {
  ...
  plotOptions: {
    bar: {
      ...
      barHeight: "20%",
      colors: {
        backgroundBarColors: [JobAdminConfig.primary],
  ...
  fill: {
    ...
    type: "gradient",
    gradient: {
      gradientToColors: [JobAdminConfig.primary],
    },
  },
  series: [
    {
