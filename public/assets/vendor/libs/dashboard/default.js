(function ($) {
  "use strict";
    ...
    var options = {
      ...
      colors:[JobAdminConfig.secondary,JobAdminConfig.primary],
      };
    ...
    var options1 = {
      ...
      colors:[ JobAdminConfig.primary, JobAdminConfig.secondary, JobAdminConfig.secondary, JobAdminConfig.secondary],
    };
    ...
    var options = {
      ...
      fill: {
        opacity: 1,
        colors: [JobAdminConfig.primary, '#eeeffe']
      },
      legend: {
        show: false
      },
    ...
    var options = {
      ...
      annotations: {
        xaxis: [{
            ...
            strokeDashArray: 0,
            borderWidth: 3,
            borderColor: JobAdminConfig.primary,
          },
        ],
        points: [{
            x: 300,
            ...
            marker: {
                size: 8,
                fillColor: JobAdminConfig.primary,
                strokeColor: JobAdminConfig.primary,
                radius: 5,
            },
            label: {
              borderWidth: 0,
      ...
      fill: {
        ...
        gradient: {
          ...
          type: "horizontal",
          shadeIntensity: 1,
          gradientToColors: [JobAdminConfig.secondary , JobAdminConfig.primary ],
          inverseColors: true,
          opacityFrom: 1,
          opacityTo: 0.2,
          stops: [0, 100, 100, 100],
    ...
    ! function(maps) {
      ...
      b.prototype.init = function() {
          maps("#asia").vectorMap({
              ...
              regionStyle: {
                  initial: {
                      fill: JobAdminConfig.primary
                  } 
              },
              zoomButtons : false,
              markers: [
                  { latLng: [39.91, 116.36], name: 'china', style: {r: 8, fill:'#61ae41'}},
                  { latLng: [24.774, 46.73], name: 'saudi Arbia', style: {r: 8, fill: JobAdminConfig.primary}},
                  { latLng: [43.238949, 76.889709], name: 'Kazakhstan', style: {r: 8, fill: JobAdminConfig.secondary}}
              ],
              series: {
            regions: [{
              scale: ['#fdd5df', '#fd0846'],
